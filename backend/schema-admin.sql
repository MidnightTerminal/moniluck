...
INSERT INTO site_settings (setting_key, setting_val, setting_type, description) VALUES
  ...
  ('footer_description', 'Premium care products for every corner of your life. From home to personal care — we''ve got you covered.', 'text', 'Footer brand description'),
  ...
  ('contact_hours',      'Mon – Sat: 9AM – 7PM',                     'text',    'Working hours'),
  ('free_shipping_enabled', 'true',                                  'boolean', 'Free shipping offer on/off'),
  ('free_shipping_min',  '50',                                       'number',  'Free shipping minimum order'),
  ('shipping_cost',      '5.99',                                     'number',  'Standard shipping cost'),
  ('express_shipping_cost', '12.99',                                  'number',  'Express shipping cost'),
  ('same_day_shipping_cost', '19.99',                                 'number',  'Same day shipping cost'),
  ('standard_shipping_time', '5–7 Business Days',                    'text',    'Standard shipping time'),
  ('express_shipping_time',  '2–3 Business Days',                    'text',    'Express shipping time'),
  ('same_day_shipping_time', 'Dhaka Only',                           'text',    'Same day shipping time'),
  ...
  ('meta_title',         'Moniluck | Care For Every Corner of Your Life', 'text', 'SEO page title'),
  ('meta_description',   'Premium care products for home, kitchen, personal and clothing needs.', 'text', 'SEO description'),
  ('privacy_policy_url',  '#',                                        'text',    'Privacy policy link'),
  ('terms_of_service_url','#',                                        'text',    'Terms of service link'),
  ('refund_policy_url',   '#',                                        'text',    'Refund policy link'),
